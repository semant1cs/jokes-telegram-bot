...
if __name__ == "__main__":
    batch_size = 2  # Batch size for each train
    num_epochs = 80  # Number of epochs of training
    out_len = 100  # Length of the output phrase
    seq_length = 100 # 50  # Determines, how long phrases will be used for training
    use_words = True   # Use words instead of characters (slower speed, bigger vocabulary)
    data_file = "train_text.txt"  # Source text file
    ...
    while True:
        us = input()
        res = generate(predict_model, vectorizer, seed=f"{us}", length=300)
        print(res)